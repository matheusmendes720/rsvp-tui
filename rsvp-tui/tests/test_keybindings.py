...
def test_defaults_match_legacy_bindings():
...
def test_resolve_honors_user_override():
...
def test_resolve_unknown_action_returns_empty_string():
    assert resolve("does_not_exist") == ""


def test_merged_bindings_overrides_apply():
...
def test_descriptions_cover_defaults():
